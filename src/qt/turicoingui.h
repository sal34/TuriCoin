...
#ifndef BITCOIN_QT_TURICOINGUI_H
#define BITCOIN_QT_TURICOINGUI_H
...
/**
  TuriCoin GUI main class. This class represents the main window of the TuriCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class TuriCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit TuriCoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~TuriCoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a turicoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(TuriCoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // BITCOIN_QT_TURICOINGUI_H
